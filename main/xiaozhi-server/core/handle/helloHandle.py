...
WAKEUP_CONFIG = {
    ...
    "responses": [
        ...
        "I'm listening carefully, please go ahead.",
        "How can I help you?",
...
async def checkWakeupWords(conn, text):
    ...
    conn.logger.bind(tag=TAG).info(f"Playing wakeup word reply: {response.get('text')}")
    ...
    # Check if wakeup word reply needs to be updated
