...
class LLMProvider(LLMProviderBase):
    def __init__(self, config):
        ...
        # Check if it's qwen3 model
        self.is_qwen3 = self.model_name and self.model_name.lower().startswith("qwen3")

    def response(self, session_id, dialogue, **kwargs):
        try:
            # If it's qwen3 model, add /no_think instruction to user's last message
            if self.is_qwen3:
            ...
            is_active = True
            # Used to handle tags across chunks
            buffer = ""
                ...
                try:
                    ...
                    if content:
                        ...
                        while "<think>" in buffer and "</think>" in buffer:
                            # Find complete <think></think> tag and remove
        ...
        try:
            ...
            for chunk in stream:
                try:
                    ...
                    # If it's tool call, pass directly
                    if tool_calls:
