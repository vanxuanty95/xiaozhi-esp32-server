                        ...
                        "function": {
                            ...
                            "parameters": {
                                ...
                                "properties": {
                                    "response_success": {
                                        "type": "string",
                                        "description": f"Friendly reply when query succeeds, must use {{value}} as placeholder for the queried value",
                                    },
                                    "response_failure": {
                                        "type": "string",
                    ...
                    parameters.update(
                        {
                            "response_success": {
                                "type": "string",
                                "description": "Friendly reply when operation succeeds",
                            },
                            "response_failure": {
                                "type": "string",
