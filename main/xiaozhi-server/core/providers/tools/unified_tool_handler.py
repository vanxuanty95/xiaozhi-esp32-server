...
class UnifiedToolHandler:
    ...
    async def _initialize(self):
        ...
        try:
            ...
            # Output all currently supported tools list
        ...
        try:
            ...
            if isinstance(arguments, str):
                try:
                    ...
                    self.logger.error(f"Unable to parse function parameters: {arguments}")
                    return ActionResponse(
                        action=Action.ERROR,
                        response="Unable to parse function parameters",
                    )

            self.logger.debug(f"Calling function: {function_name}, parameters: {arguments}")
