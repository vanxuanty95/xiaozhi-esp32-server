...
class TTSProvider(TTSProviderBase):
    ...
    def _get_auth_headers(self, request_body):
        ...
        # Request headers must include host and content-type, and be sorted alphabetically
        canonical_headers = (
    ...
    async def text_to_speak(self, text, output_file):
        ...
        try:
            # Get request headers (regenerated for each request to ensure timestamp and signature are latest)
